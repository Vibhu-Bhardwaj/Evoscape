...
import {Box,Button,Card,CardFooter,Divider,Heading,Image,Stack,Text} from "@chakra-ui/react";
...
export default function MyAds() {
  ...
  useEffect(() => {
    const fetchAds = async () => {
      ...
      const response = await axios.get("https://evoscape-server-a8ey.onrender.com/myads_view", {
        headers: {
