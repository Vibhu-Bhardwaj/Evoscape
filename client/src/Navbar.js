  ...
  return (
    <div className="">
      <MDBNavbar expand="lg" style={{ backgroundColor: "rgba(235, 238, 239, 1)" }}>
        <MDBContainer fluid>
          <MDBNavbarBrand href="/">
            <img src={logo} height="50" className="logo" width="140" alt="" loading="lazy"/>
          </MDBNavbarBrand>
          ...
          <MDBCollapse navbar show={showNavNoTogglerSecond}>
            ...
            {auth === false && (
              //todo size = "lg"
              <MDBBtn className="d-flex w-auto mb-3 mx-2 btn btn-primary mt-3"size="lg"onClick={toggleShow}> 
                <span>
                  <MDBIcon className="mx-1" far icon="user-circle" size="lg" />Login
                </span>
              </MDBBtn>
            )}
            <MDBBtn className="d-flex w-auto mb-3 mx-2 btn btn-info mt-3"size="lg" href="/sell">
              <span>
                <MDBIcon className="mx-1" fas icon="shopping-cart" size="lg" />Sell
              </span>
            </MDBBtn>
          </MDBCollapse>
        </MDBContainer>
