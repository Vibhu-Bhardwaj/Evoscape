...
import ForgotPassword from './PasswordResetComponents/forgotpass';
import ResetPassword from "./PasswordResetComponents/resetpass";
...
function App() {
  ...
  async function checkBackendStatus() {
    try {
      const response = await fetch('https://evoscape-server-a8ey.onrender.com/api/check-status');
  ...
  async function checkAuthentication() {
    try {
      ...
      const response = await fetch('https://evoscape-server-a8ey.onrender.com/auth-endpoint', {
        headers: {
